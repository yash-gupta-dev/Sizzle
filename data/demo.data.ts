...
export const TEMP_CREATOR_DATA = [
    ...
    },
    {
        ...
        tagline: 'The tall blonde your algorithm keeps showing you',
        featuredImages: ["/images/creator-star2.jpg", "/images/creator-star1.jpg", "/images/creator-star2.jpg"],
        primaryColor: '#7E37E7',
        categories: ["Curvy", "Nerdy", "Playful"],
        name: "Roxie Sinclair",
        photos: 44,
...
export const TEMP_FEATURED_CREATORS = [
    {
        isNew: false,
        isLocked: false,
        duration: "4:28",
