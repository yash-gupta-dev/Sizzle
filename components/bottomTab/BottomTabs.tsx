...
export default function BottomTabs() {
    ...
    return (
        ...
        >
            <div
                className={"flex items-center justify-between rounded-[34px] px-10 py-3.75 bg-nav-bg/45 backdrop-blur-xl backdrop-saturate-150 shadow-[0_8px_30px_rgb(0,0,0,0.12)] border-t border-border-muted"}
            >
                {
                    tabs.map(t => {
